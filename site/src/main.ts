...
function landing(): string {
  ...
  <section class="preview section-pad ruled" aria-labelledby="preview-title"><div class="margin-label">Sample note 3 · due today</div><div class="preview-sheet"><p class="eyebrow">Live review preview</p><h2 id="preview-title">Recall the missing word</h2><blockquote lang="fr">La vie est une fleur dont l’amour est le <mark>_____</mark>.</blockquote><p class="gloss">Your gloss: Life is a flower whose honey is love.</p><div class="preview-actions"><a class="button secondary nav-link" href="/?demo=1">Reveal it in the demo</a><a href="https://fr.wikisource.org/wiki/Les_Chansons_des_rues_et_des_bois" rel="external">Open original page <span class="sr-only">(external)</span> ↗</a></div></div></section>
