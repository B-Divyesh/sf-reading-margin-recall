...
function render() {
  ...
  if (!note) {
    main.innerHTML = `<h1>Save a passage to begin</h1><div class="empty"><span aria-hidden="true">⌇</span><p>Select a sentence on a web page. Then choose <strong>Save passage</strong>.</p></div><button id="open-site" class="secondary">Open the separate web app</button>`;
