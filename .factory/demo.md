...
Open `https://reading-margin-recall.sociobot.in/?demo=1` or use `http://localhost:5173/?demo=1` during development.
...
Choose **Reset demo** to restore the three bundled notes. Choose **Exit demo and use my notes** to delete every `demo:` key and open the real notes screen. Demo notes are never copied into real storage.
